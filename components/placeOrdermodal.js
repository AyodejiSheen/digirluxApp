...
const PlaceOrdermodal = () => {
  ...
  return (
    <View className="justify-center">
      <Pressable onPress={() => setModalVisible(!modalVisible)} className="bg-black py-4 rounded-full">
        <Text className="text-white font-medium text-center">SHOW TOTAL</Text>
      </Pressable>
          ...
          <Modal
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView} className="w-4/5 rounded-lg pb-4">
                ...
                <View className="px-6 border-t pt-4 border-slate-300">
                  <Pressable onPress={() => navigation.navigate('Order')} className="bg-teal-700 py-3 rounded-md">
