...
export const LoginScreen = () => {
    return (
        <>
            ...
            <View className="space-y-10 w-10/12">
                ...
                <View className="space-y-3">
                    <View className="space-y-4">
                        <Text className="text-6xl  text-slate-600 font-bold">Hey,</Text>
                        <Text className="text-4xl text-slate-600  font-bold">Login Now.</Text>
                    </View>
                ...
                <View>
                    ...
                    <Pressable className="shadow-lg shadow-teal-200 bg-teal-700 py-4  rounded-lg">
